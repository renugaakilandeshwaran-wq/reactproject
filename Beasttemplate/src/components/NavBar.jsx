...
export default function NavBar() {
    ...
    return (
        <nav className="w-full relative bg-white md:bg-transparent">
            <div className="max-w-[1296px] mx-auto flex items-center justify-between px-6 lg:px-12 py-6">
            ...
            {menuOpen && (
                <div className="fixed inset-0  bg-white z-50 flex flex-col items-center justify-center  gap-8">
                    ...
                    <Link
                        to="/#joinnow"
                        onClick={() => setMenuOpen(false)}
                        className="bg-[#FA2A20] text-white px-6 py-3"
                    >
                        JOIN NOW
                    </Link>
                </div>
